  ...
  <div class="invitation-container">
    ...
    <div class="invitation-card">
      <div class="invitation-header">
        <h1 class="birthday-title">🎉 Tu es invité ! 🎉</h1>
        <p class="birthday-subtitle">Viens fêter avec nous !</p>
      </div>
...
<style scoped>
.invitation-container{min-height:100vh;background:linear-gradient(135deg,#667eea,#764ba2);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:20px;position:relative;overflow:hidden}
...
.invitation-card{background:#fff;border-radius:20px;box-shadow:0 25px 50px #0000001a;max-width:500px;width:100%;overflow:hidden;animation:slideIn-781963a1 .8s ease-out}
@keyframes slideIn-781963a1{0%{opacity:0;transform:translateY(50px)}to{opacity:1;transform:translateY(0)}}
.invitation-header{background:linear-gradient(135deg,#ff6b6b,#ff8e8e);color:#fff;padding:30px;text-align:center}
.birthday-title{font-size:1.8rem;margin-bottom:10px;font-weight:700}
.birthday-subtitle{opacity:.9;font-size:1.1rem}
.invitation-body{padding:30px}
.birthday-person{text-align:center;color:#ff6b6b;font-size:1.5rem;margin-bottom:15px;font-weight:600}
.age-badge{background:linear-gradient(135deg,#ffd93d,#ff6b6b);color:#fff;padding:10px 20px;border-radius:25px;text-align:center;font-weight:700;font-size:1.2rem;margin:0 auto 25px;display:inline-block;box-shadow:0 4px 15px #ff6b6b4d}
.event-details{margin:25px 0}
.detail-item{display:flex;align-items:center;margin-bottom:15px;font-size:1rem;color:#333}
.detail-icon{color:#ff6b6b;margin-right:12px;width:20px;text-align:center}
...
.rsvp-button,.lookup-button{color:#fff;border:none;padding:15px 30px;border-radius:25px;font-size:1.1rem;font-weight:600;cursor:pointer;transition:all .3s ease;min-width:200px}
.rsvp-button{background:linear-gradient(135deg,#4ecdc4,#44a08d);box-shadow:0 4px 15px #4ecdc44d}
.rsvp-button:hover{transform:translateY(-2px);box-shadow:0 8px 25px #4ecdc466}
.lookup-button{background:linear-gradient(135deg,#667eea,#764ba2);box-shadow:0 4px 15px #667eea4d}
.lookup-button:hover{transform:translateY(-2px);box-shadow:0 8px 25px #667eea66}
.lookup-form{background:#f0f4ff;padding:25px;border-radius:15px;margin-top:20px;border:2px solid #e1e5e9}
.lookup-form h3{color:#667eea;margin-bottom:20px;text-align:center}
.rsvp-form{background:#f8f9fa;padding:25px;border-radius:15px;margin-top:20px}
.rsvp-form h3{color:#ff6b6b;margin-bottom:20px;text-align:center}
...
.radio-option:hover{border-color:#ff6b6b;background-color:#fef7f7}
.radio-option input[type=radio]{display:none}
.radio-option.selected{border-color:#ff6b6b;background-color:#fef7f7}
...
.form-group textarea:focus{outline:none;border-color:#ff6b6b}
...
.submit-button{background:linear-gradient(135deg,#ff6b6b,#ff8e8e);color:#fff}
.submit-button:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 4px 15px #ff6b6b4d}
.submit-button:disabled{opacity:.7;cursor:not-allowed}
.confirmation-message{background:linear-gradient(135deg,#4ecdc4,#44a08d);color:#fff;padding:25px;border-radius:15px;text-align:center;margin-top:20px}
