...
export const THEMES = {
  fiesta: {
    ...
    palette: {
      ...
      badgeFrom: '#FFB703', badgeTo: '#FB8500', buttonFrom: '#FF4D6D', buttonTo: '#C9184A', badgeText: '#1F2333', buttonText: '#FFFFFF'
    },
  ...
  spiderman: {
    ...
    palette: {
      ...
      badgeFrom: '#E23636', badgeTo: '#1D4ED8', buttonFrom: '#E23636', buttonTo: '#A11616', badgeText: '#FFFFFF', buttonText: '#FFFFFF'
    },
  ...
  ironman: {
    ...
    palette: {
      ...
      badgeFrom: '#FFC300', badgeTo: '#E08A00', buttonFrom: '#D7263D', buttonTo: '#8C0E1E', badgeText: '#2A1206', buttonText: '#FFFFFF'
    },
  ...
  pawpatrol: {
    ...
    palette: {
      ...
      badgeFrom: '#FFD200', badgeTo: '#FFA000', buttonFrom: '#E4002B', buttonTo: '#B00020', badgeText: '#16334A', buttonText: '#FFFFFF'
    },
    fonts: { display: "'Baloo 2', 'Trebuchet MS', 'Comic Sans MS', cursive", body: "'Nunito', 'Segoe UI', system-ui, sans-serif" },
    heroEmojis: ['🐾', '🚓', '🚒'],
    decorations: ['🐾', '🐶', '🚓', '🚒', '🚁', '⭐'],
  ...
  mickey: {
    ...
    palette: {
      ...
      badgeFrom: '#FFC60A', badgeTo: '#F59E0B', buttonFrom: '#D7141A', buttonTo: '#9E0B10', badgeText: '#1A1A1A', buttonText: '#FFFFFF'
    },
    fonts: { display: "'Baloo 2', 'Trebuchet MS', 'Comic Sans MS', cursive", body: "'Nunito', 'Segoe UI', system-ui, sans-serif" },
    heroEmojis: ['🐭', '🎈', '🎀'],
    decorations: ['🐭', '🎈', '🎀', '⭐', '🧤', '🎉'],
  ...
  princess: {
    ...
    palette: {
      ...
      badgeFrom: '#F3D27A', badgeTo: '#E0A93B', buttonFrom: '#E86AA6', buttonTo: '#C44D88', badgeText: '#4A2740', buttonText: '#FFFFFF'
    },
  ...
  dino: {
    ...
    palette: {
      ...
      badgeFrom: '#E8B23A', badgeTo: '#C8860F', buttonFrom: '#2E8B57', buttonTo: '#1E5E3A', badgeText: '#22331C', buttonText: '#FFFFFF'
    },
  ...
  space: {
    ...
    palette: {
      ...
      badgeFrom: '#22D3EE', badgeTo: '#3B82F6', buttonFrom: '#7C3AED', buttonTo: '#4C1D95', badgeText: '#07223A', buttonText: '#FFFFFF'
    },
  ...
  unicorn: {
    ...
    palette: {
      ...
      badgeFrom: '#FFD166', badgeTo: '#FF9A8B', buttonFrom: '#FF7EB9', buttonTo: '#E0559A', badgeText: '#46264D', buttonText: '#46264D'
    },
    fonts: { display: "'Pacifico', 'Brush Script MT', 'Comic Sans MS', cursive", body: "'Quicksand', 'Segoe UI', system-ui, sans-serif" },
    heroEmojis: ['🦄', '🌈', '✨'],
    decorations: ['🦄', '🌈', '✨', '☁️', '💖', '⭐'],
